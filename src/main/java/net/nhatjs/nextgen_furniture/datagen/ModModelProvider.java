...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.AIO_COOLER_3_FANS);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BED_GRAY_WOOD_BIRCH);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BED_GRAY_WOOD_OAK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BED_WHITE_WOOD_BIRCH);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.BED_WHITE_WOOD_OAK);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.GRAPHICS_CARD_GAMING);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.KEYBOARD_MECHANICAL_BLACK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.KEYBOARD_MECHANICAL_BLACK_WOOD_BIRCH);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.KEYBOARD_MECHANICAL_BLACK_WOOD_OAK);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.MONITOR_GAMING_MINIMALIST);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.MOUSE_GAMING_BLACK);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_1);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_2);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_3);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_4);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_5);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_6);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_7);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.PC_GAMING_ADDED_8);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.TRASH_CAN_BLACK);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.TRASH_CAN_WHITE);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.TV_STAND_WOOD_BIRCH);
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.TV_STAND_WOOD_OAK);
        ...
        blockStateModelGenerator.registerNorthDefaultHorizontalRotatable(ModBlocks.WARDROBE_MODERN_WOOD_BIRCH_LEFT);
