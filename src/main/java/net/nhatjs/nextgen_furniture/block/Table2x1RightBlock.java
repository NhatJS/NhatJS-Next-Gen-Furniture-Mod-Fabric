...
public class Table2x1RightBlock extends Block {
    ...
    public Table2x1RightBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (player.isSneaking()) {
            if ((world.getBlockState(BlockPos.ofFloored(x, y, z))).getBlock() == ModBlocks.TABLE_2X1_BLACK_ALT_2) {
                {
                    BlockPos _bp = BlockPos.ofFloored(x, y, z);
                    BlockState _bs = ModBlocks.TABLE_2X1_BLACK.getDefaultState();
