...
public class DualMonitorAlternateBlock extends Block {
    ...
    public DualMonitorAlternateBlock(Settings settings) {
        super(settings);
    ...
    private static final VoxelShape NORTH = VoxelShapes.union(
            Block.createCuboidShape(-8.5, 0, 11, 24.5, 13, 15),
    ...
    private static final VoxelShape SOUTH = VoxelShapes.union(
            Block.createCuboidShape(-8.5, 0, 1, 24.5, 13, 5),
    ...
    private static final VoxelShape EAST = VoxelShapes.union(
            Block.createCuboidShape(1, 0, -8.5, 5, 13, 24.5),
    ...
    private static final VoxelShape WEST = VoxelShapes.union(
            Block.createCuboidShape(11, 0, -8.5, 15, 13, 24.5),
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (player.isSneaking() && !current) {
            ...
            world.setBlockState(pos, ModBlocks.MONITOR_DUAL_ALT_2.getDefaultState()
                    .with(HorizontalFacingBlock.FACING, facing)
                    .with(DualMonitorAlternate2Block.TURN_ON, false), Block.NOTIFY_ALL);
            return ActionResult.SUCCESS;
        }
        else if (player.getMainHandStack().isOf(ModItems.SCREWDRIVER) && !current) {
            Direction facing =  state.get(HorizontalFacingBlock.FACING);
