...
public class GamingPCAdded2Block extends Block {
    ...
    public GamingPCAdded2Block(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (stack.isOf(ModBlocks.AIO_COOLER_3_FANS.asItem())) {
            Direction facing =  state.get(HorizontalFacingBlock.FACING);
            world.setBlockState(pos, ModBlocks.PC_GAMING_ADDED_3.getDefaultState()
